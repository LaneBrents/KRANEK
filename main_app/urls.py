...
urlpatterns = [
    ...
    path('decks/<int:deck_id>/assoc_flashcard/<int:flashcard_id>/',
         views.assoc_flashcard, name='assoc_flashcard'),

    path('flashcards/', views.FlashcardList.as_view(), name='flashcards_index'),
    path('flashcards/<int:pk>/', views.FlashcardDetail.as_view(),
         name='flashcards_detail'),
    path('flashcards/create/', views.FlashcardCreate.as_view(),
         name='flashcards_create'),
    path('flashcards/<int:pk>/update/',
         views.FlashcardUpdate.as_view(), name='flashcards_update'),
    path('flashcards/<int:pk>/delete/',
         views.FlashcardDelete.as_view(), name='flashcards_delete'),
    ...
    path('quiz/<int:quiz_id>/add_question/',
         views.add_question, name='add_question'),
    path('quiz/<int:quiz_id>/assoc_question/<int:question_id>/',
         views.assoc_question, name='assoc_question'),
    path('quiz/<int:quiz_id>/unassoc_question/<int:question_id>/',
         views.unassoc_question, name='unassoc_question'),
